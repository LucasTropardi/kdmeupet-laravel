        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden border border-gray-200 shadow-lg sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <p class="text-xl text-center">Aqui está a lista de cores cadastradas para os registros de animais.</p>
                </div>
                <div class="px-6 text-gray-900 text-left">
                    <x-external-button route="cor.create" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700
                                ...
                                <tbody>
                                    @foreach ($cores as $cor)
                                        <tr class="odd:bg-white even:bg-gray-100 border-b text-base font-medium">
                                            <td class="px-12">{{ ($cor->cor) }}</td>
                                            <td class="text-center p-4 space-x-2">
                                                <a title="Editar" class="bg-white text-blue-600 py-2 px-3 rounded border border-blue-600 hover:bg-blue-600 hover:text-white" href="{{ route('cor.edit', $cor->id) }}">
                                                    <i class="fa-solid fa-pencil"></i>
                                                </a>
                                                <a href="#" title="Excluir cor" class="excluir-cor bg-white text-red-600 py-2 px-4 rounded border border-red-600 hover:bg-red-600 hover:text-white" data-cor-id="{{ $cor->id }}">
