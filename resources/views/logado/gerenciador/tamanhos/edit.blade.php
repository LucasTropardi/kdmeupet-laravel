            ...
            <div class="bg-gray-50 overflow-hidden border border-gray-200 shadow-lg sm:rounded-lg pb-8">
                <div class="w-full mx-auto mt-8 sm:max-w-md px-2 py-2 bg-blue-200 shadow-md overflow-hidden sm:rounded-lg mb-2" id="form-cadastrar">
                    <div class="bg-white p-6">
                        ...
                        <p class="mb-8 mt-4 text-xl text-left">Informe os dados do tamanho, <strong>{{ Auth::user()->name }}</strong>.</p>
                        <form action="{{ route('tamanho.update', $tamanho->id) }}" method="post">
                            ...
                            <x-select class="w-full rounded-lg" name="especie_id" :options="$especies" :selected="$tamanho->especie_id" />
