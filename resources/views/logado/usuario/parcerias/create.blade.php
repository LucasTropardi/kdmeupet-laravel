<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Cadastrar parceria') }}
        </h2>
    </x-slot>
    @section('title','Cadastro de parceria')
                ...
                <div class="p-6 text-gray-900" id="form-cadastrare">
                    <div class="flex flex-col items-center pt-2 sm:pt-0" id="div-cadastrar">
                        <div class="w-full sm:max-w-md mt-2 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg mb-12" id="form-cadastrar">
                            <div>
                                <p class="mb-8 text-xl">Informe os dados da entidade/parceiro abaixo, <strong>{{ Auth::user()->name }}</strong>.</p>
                                <form action="{{ route('parceria.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <!-- User -->
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <x-text-input id="parNome" class="block mt-1 w-full" type="text" name="parNome" :value="old('parNome')" required autofocus autocomplete="parNome" />
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <x-text-input id="parEmail" class="block mt-1 w-full" type="text" name="parEmail" :value="old('parEmail')" required autocomplete="parEmail" />
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <x-text-input id="parTelefone" class="block mt-1 w-full" type="text" name="parTelefone" :value="old('parTelefone')" required autocomplete="parTelefone" />
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <x-text-input id="parEndereco" class="block mt-1 w-full" type="text" name="parEndereco" :value="old('parEndereco')" required autocomplete="parEndereco" />
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <x-textarea-input class="w-full block mt-1" rows="4" id="parDescricao" type="text" name="parDescricao" :value="old('pardescricao')" autocomplete="parDescricao"></x-textarea-input>
                                    </div>

                                    <!-- Mensagem-->
                                    <div class="mb-4">
                                        <x-input-label for="parMensagem" :value="__('Mensagem para o administrador do site')" />
                                        <x-textarea-input class="w-full block mt-1" rows="4" id="parMensagem" type="text" name="parMensagem" :value="old('parMensagem')" autocomplete="parMensagem"></x-textarea-input>
                                    </div>
