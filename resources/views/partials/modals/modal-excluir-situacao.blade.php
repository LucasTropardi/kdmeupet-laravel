    ...
    <div class="bg-white rounded-lg p-8 max-w-md w-full">
        ...
        <div class="flex justify-center">
            <form action="{{ route('situacao.destroy', 0) }}" method="post" id="excluirSituacaoForm">
                ...
                <button type="button" class="font-medium text-lg px-4 py-2.5 bg-gray-300 hover:bg-gray-400 rounded-lg mr-2" id="cancelBtnSituacaoExcluir">Cancelar</button>
                <button type="button" class="font-medim text-lg text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg inline-flex items-center px-5 py-2.5 text-center" id="confirmBtnSituacaoExcluir">Excluir</button>
            </form>
        </div>
    </div>
</div>
